...
class Server extends Extensible {
    ...
    constructor(options) {
        ...
        console.info('Created new server: %s', JSON.stringify(this._options));
    }
    ...
    process(messages, request, callback, context) {
        ...
        console.info('Processing messages: %s (local: %s)', messages, local);
        ...
        var gatherReplies = function (replies) {
            ...
            console.log('Returning replies: %s', JSON.stringify(responses));
        ...
        var handleReply = function (replies) {
            ...
            for (var i = 0, n = replies.length; i < n; i++) {
                console.log('Processing reply: %s', JSON.stringify(replies[i]));
                (function (index) {
    ...
    _handle(message, local, callback, context) {
        ...
        console.info('Handling message: %s (local: %s)', JSON.stringify(message), local);
    ...
    handshake(message, local, callback, context) {
        ...
        console.log('in handshake handshake handshake handshake');
